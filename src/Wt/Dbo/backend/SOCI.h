 ...
 */
#ifndef WT_DBO_BACKEND_SOCISERVER_H_
#define WT_DBO_BACKEND_SOCISERVER_H_

#include <Wt/Dbo/SqlConnection.h>
#include <Wt/Dbo/SqlStatement.h>
#include <Wt/Dbo/backend/WDboSOCIDllDefs.h>

namespace Wt {
  namespace Dbo {
    namespace backend {

/*! \class SOCI Wt/Dbo/backend/SOCI Wt/Dbo/backend/SOCI
 *  \brief A SOCI connection
 *
 * This class provides the backend implementation for SOCI connections
 *
 * \ingroup dbo
 */
class WTDBOSOCISERVER_API SOCI : public SqlConnection
{
public:
   ...
   * \sa connect()
   */
  SOCI(const std::string &connectionString);
...
#endif // WT_DBO_BACKEND_SOCISERVER_H_
